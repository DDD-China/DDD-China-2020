$(function() {
  ...
  var templateHTMl = $(
    '<div class="grid producer-grid-space centered">\n' +
  ...
  // if (index % 2 === 1) {
  $(".speaker-info .speaker-topic", producerWrapper).css({
    "background-color": "red"
  });
  $(".speaker-topic-import-icon", producerWrapper).css({
    "border-bottom": "10px solid red"
  });
  // }
  $(".speaker-info .speaker-img img", producerWrapper)
    .attr("src", producer["producer-img"])
    .attr("alt", producer["producer-name"]);
  $(
    ".speaker-info .speaker-detail .speaker-detail-introduction .speaker-name",
    producerWrapper
  ).append(producer["producer-name"]);
  $(
    ".speaker-info .speaker-detail .speaker-detail-introduction .speaker-title",
    producerWrapper
  ).append(producer["producer-introduction"]);
  $(".speaker-detail .speaker-detail-information", producerWrapper).append(
    producer["producer-information"]
  );

  $(
    ".speaker-info .speaker-topic .speaker-topic-content",
    producerWrapper
  ).append(producer["producer-topic"]);
  $(
    ".speaker-info .speaker-topic-detail .speaker-topic-content-detail",
    producerWrapper
  ).append(producer["topic-information"]);
